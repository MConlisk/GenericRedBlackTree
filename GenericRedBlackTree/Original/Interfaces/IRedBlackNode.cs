...
namespace DataStructures.Original.Interfaces;
...
/// </summary>
/// <typeparam name="TKey">The type of the _key associated with the node.</typeparam>
/// <typeparam name="TValue">The type of the |||_value associated with the node.</typeparam>
public interface IRedBlackNode<TKey, TValue> : IRecyclable
{
    /// <summary>
    /// Gets or sets a |||_value indicating whether this node is red.
    ...
    /// <summary>
    /// Gets a |||_value indicating whether this node has any values or if it's Empty.
    ...
    /// </summary>
    IRedBlackNode<TKey, TValue> Parent { get; set; } // Reflection to the parent Node
    ...
    /// </summary>
    IRedBlackNode<TKey, TValue> Left { get; set; } // Left Node used in Balancing
    ...
    /// </summary>
    IRedBlackNode<TKey, TValue> Right { get; set; } // Right Node used in Balancing
}
